...
public class Methods {
	...
	public static String readVal = null;
	public static JSONObject content = new JSONObject(readVal);
	public static JSONArray teams = content.getJSONArray("team");
	public static JSONArray admins = content.getJSONArray("admins");
	public static JSONArray judges = content.getJSONArray("judges");
	public static JSONArray spects = content.getJSONArray("spectators");
	...
	public static boolean login(int loginChoice) {
		...
		case 1 :{ //ADMIN AUTH
			...
			for(int i = 0; i < admins.length(); i++) {
				JSONObject toRead = admins.getJSONObject(i);
